...
const Departamento: React.FC = () => {
  ...
  const handleConsulta = async () => {
    try {
      ...
      if (selectedCentroCusto !== null && selectedDepartamento !== null) {
        url += `centro-custo/${selectedCentroCusto}/departamento/${selectedDepartamento}`;
      } else if (selectedCentroCusto !== null) {
