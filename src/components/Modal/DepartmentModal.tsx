...
const DepartmentModal: React.FC<DepartmentModalProps> = ({ isOpen, onClose, department }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white dark:bg-[--body] p-8 rounded-lg shadow-lg relative w-1/2">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="text" className="input input-focus" value={department.centroCusto} readOnly />
          </div>
          <div>
            <label>Departamento</label>
            <input type="text" className="input input-focus" value={department.departamento} readOnly />
          </div>
          <div>
            <label>Número Departamento</label>
            <input type="text" className="input input-focus" value={department.numeroDepartamento} readOnly />
          </div>
